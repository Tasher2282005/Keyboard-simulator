// Буквы для урока
const lessonLetters = [ 'Ы', 'О', 'Ж', 'Ф', 'В', 'А', 'О', 'Л','Ж', 'Ф', 'Ы', 'В', 'А', 'Л', 'Д', 'Ж', 'Ф', 'Ы', 'В', 'А', 'О', 'Л', 'Д', 'Ж', 'Ф', 'Ы', 'В', 'А',];
const letterColors = {
...
nextLessonButton.addEventListener('click', function() {
  ...
  window.location.href = 'lesson2.html'; // Замените 'lesson2.html' на URL следующего урока
});
