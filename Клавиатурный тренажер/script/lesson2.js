// Буквы для урока
const lessonLetters = ['Ф', 'Ы', 'В', 'А', 'Л', 'Д', 'Ж', 'О','Ф', 'Ы', 'В', 'А', 'Л', 'Д', 'Ж', 'О', 'Е', 'П', 'И', 'М', 'Н', 'Р', 'Т', 'Ь', 'Е', 'П', 'И', 'М', 'Н', 'Р', 'Т', 'Ь', 'Е', 'Н', 'И', 'Т', 'Ь', 'Е', 'П', 'И', 'М', 'Н', 'Р', 'Т', 'Ь'];
const letterColors = {
  'А': 'is-info',
  'Ф': 'is-danger',
  'Ы': 'is-warning',
...
nextLessonButton.addEventListener('click', function() {
  ...
  window.location.href = 'lesson3.html'; // Замените 'lesson2.html' на URL следующего урока
});
