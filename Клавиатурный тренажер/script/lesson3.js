// Буквы для урока
const lessonLetters = ['Ф', 'Ы', 'В', 'А', 'Л', 'Д', 'Ж', 'О', 'Е', 'П', 'И', 'М', 'Н', 'Р', 'Т', 'Ь', 'У', 'К', 'Г', 'Ш', 'Ч', 'С', 'Б', 'Ю', 'У', 'К', 'Г', 'Ш', 'Ч', 'С', 'Б', 'Ю', 'У', 'К', 'Г', 'Ш', 'Ч', 'С', 'Б', 'Ю'];
const letterColors = {
  'Ф': 'is-danger',
  'Ы': 'is-warning',
  'В': 'is-primary',
...
nextLessonButton.addEventListener('click', function() {
  ...
  window.location.href = 'lesson4.html'; // Замените 'lesson2.html' на URL следующего урока
});
